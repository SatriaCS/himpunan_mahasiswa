...
export async function PUT(req) {
    ...
    try {
        ...
        await conn.rollback();
        console.error("[ERROR] PUT /api/super-admin/akun-admin/edit-password:", error);
        ...
        if (isConnectionError) {
            return NextResponse.json(
                { 
                    message: "Gangguan koneksi Gagal mengedit data password akun. Silakan coba beberapa saat lagi.",
                },
