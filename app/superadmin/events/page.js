...
export default function EventsPage() {
    ...
    const confirmDelete = async() => {
        ...
        try {
            ...
            const res = await fetch(`/api/super-admin/event?id=${selectedEvent.id}`, {
                method: "DELETE"
            });
    ...
    const confirmHeadline = async() => {
        ...
        try {
            ...
            const res = await fetch("/api/super-admin/event/update-headline", {
                method: "PUT",
                headers: {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            ...
            const res = await fetch("/api/super-admin/event", {
                method: "POST",
                body: data
            });
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                ...
                                <option value="tanggal">Terdekat</option>
                            </select>
                        </div>
                    </div>
                                    ...
                                    <div key={event.id} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 hover:shadow-md transition-shadow">
                                        ...
                                        <div className="flex-1 py-2">
                                            <div className="flex items-center gap-3 mb-2">
                                                ...
                                                {event.headline && (
                                                    <span className="px-3 py-1 bg-green-50 text-green-600 border border-green-200 rounded-full text-xs font-bold flex items-center gap-1">
                                                        📢 Headline Aktif
                                                    </span>
                                                )}                                                
                                            </div>
                                            ...
                                            <p
                                                className="text-sm text-gray-600 mt-2 transition-all duration-300 line-clamp-3"
                                            >
                                                {event.deskripsi}
                                            </p>
                                        </div>
